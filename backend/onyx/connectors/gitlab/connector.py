...
def _should_exclude(path: str) -> bool:
    ...
    Matching rules:
      - Patterns containing "/" match against the full path via fnmatch.
        Trailing-slash patterns like ".github/" are normalized to ".github"
        and treated as directory-name patterns.
